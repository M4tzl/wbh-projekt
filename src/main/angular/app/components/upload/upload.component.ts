...
export class UploadComponent {
    @Input()
    inseratBild: BildMetadaten = <BildMetadaten> {};

    @Output()
    imageUploaded: EventEmitter<ImageUploadResult> = new EventEmitter();

    get imageSource(): string {
        return this.inseratBild.bildKey ? `/api/inserate/${this.inseratBild.entityId}/images/${this.inseratBild.bildKey}`
